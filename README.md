...
```bash
git clone https://github.com/hchintakuntla/creditCardFraudDetection.git
...
Hamsika Chintakuntla is a Data Analyst with over 4 years of experience in delivering data-driven solutions across financial services and healthcare technology. She specializes in Python, SQL, and machine learning integration to transform complex datasets into actionable business insights. This project reflects her focus on building scalable MLOps pipelines and AI-powered analytics to support predictive decision-making and operational efficiency.

### Contact Information

- Email: chintakuntlahamsika@gmail.com
- GitHub: hchintakuntla
- LinkedIn: hamsika-chintakuntla